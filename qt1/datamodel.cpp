...
datamodel::datamodel(string path)
{
	m_totalVertex = 0;
	m_totalFace = 0;
	m_totalVertexProperty = 0;
...
int  datamodel::getTotalVertex()
{
	return this->m_totalVertex;
}

int  datamodel::getTotalFace()
{
...
* 获取模型面顶点总数,三角网格。
*/
int  datamodel::getTotalFaceVertex3()
{
...
* 绑定文件路径。
*/
void datamodel::setPath(string path)
{
	this->path = path;
	this->clear();
}

const char* datamodel::getPath()
{
	return this->path.data();
}

bool datamodel::clear()
{
	vecVertex.clear();
